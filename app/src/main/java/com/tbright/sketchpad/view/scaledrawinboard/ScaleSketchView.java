package com.tbright.sketchpad.view.scaledrawinboard;
...
public class ScaleSketchView extends   RelativeLayout {
    ...
    private void init(Context context) {
        RelativeLayout.LayoutParams pathViewParams = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT,
                RelativeLayout.LayoutParams.MATCH_PARENT);
        pathView=new PathView(getContext());
        addView(pathView,pathViewParams);
    }

    public ScaleSketchView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ScaleSketchView(Context context, AttributeSet attrs, int defStyleAttr) {
