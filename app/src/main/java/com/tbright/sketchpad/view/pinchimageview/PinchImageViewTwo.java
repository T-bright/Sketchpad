...
public class PinchImageViewTwo extends ImageView {
...
////////////////////////////////配置参数////////////////////////////////
    ...
    public boolean canScrollHorizontally(int direction) {
        if (mPinchMode == PinchImageViewTwo.PINCH_MODE_SCALE) {
            return true;
        }
    ...
    public interface OuterMatrixChangedListener {
         ...
         */
        void onOuterMatrixChanged(PinchImageViewTwo pinchImageView);
    }
    ...
    public PinchImageViewTwo(Context context) {
        super(context);
        initView();
    }

    public PinchImageViewTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public PinchImageViewTwo(Context context, AttributeSet attrs, int defStyle) {
     ...
     * 在onTouchEvent末尾被执行.
     */
    private GestureDetector mGestureDetector = new GestureDetector(PinchImageViewTwo.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (mOnLongClickListener != null) {
                mOnLongClickListener.onLongClick(PinchImageViewTwo.this);
            }
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            if (mOnClickListener != null) {
                mOnClickListener.onClick(PinchImageViewTwo.this);
            }
            return true;
        }
    });
